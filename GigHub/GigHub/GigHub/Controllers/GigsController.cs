    ...
    public class GigsController : Controller
    {
        ...
        public ActionResult Attending()
        {
            ...
            var viewModel = new GigsViewModel()
            {
                ...
                //Followings = _followingRepository.GetFollowees(userId).ToLookup(f => f.FolloweeId)
            };
        ...
        {
            var userId = User.Identity.GetUserId();
            var artists = _followingRepository.GetFollowees(userId);
        ...
        public ActionResult Details(int id)
        {
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                viewModel.IsAttending = _attendanceRepository.GetFutureAttendance(gig.Id, userId) != null;
